<div class="absolute top-0 right-0 w-full max-w-sm px-6 py-2 m-2 font-bold text-gray-500 bg-white rounded-lg shadow-lg"
    ...
    <div class="flex justify-end mb-4"> <svg class="w-6 h-6 cursor-pointer fill-current hover:text-gray-900"
            @click="open = false" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path
    ...
    <div x-data="{ open: false }">
        <div class="flex justify-between"> <span class="font-bold">Acceso</span> <svg x-show="!open"
                @click="open = true" class="w-6 h-6 cursor-pointer fill-current" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z" />
            </svg> <svg x-show="open" @click="open = false" class="w-6 h-6 cursor-pointer fill-current"
