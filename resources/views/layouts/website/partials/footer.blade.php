<div class="flex flex-wrap items-baseline justify-around py-5 mt-10 leading-loose text-gray-500 bg-gray-900">
    ...
    <a href="#" class="px-2 py-5 hover:text-gray-200">Política de cookies</a>
    <a href="#" class="px-2 py-5 hover:text-gray-200">Mapa del sitio</a>
    <div class="flex justify-between py-5">
        <a href="#" class="px-2 hover:text-gray-200" aria-label="Facebook">
        ...
        <a href="#" class="px-2 hover:text-gray-200" aria-label="Twitter">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 310 310" class="w-5 h-5 fill-current">
                <path
        ...
        <a href="#" class="px-2 hover:text-gray-200" aria-label="LinkedIn">
