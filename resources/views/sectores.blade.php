    ...
    <div class="flex flex-wrap justify-center max-w-xl px-2 mx-auto mt-10 lg:max-w-6xl lg:px-20">
        <div class="w-48 h-48 p-2 hover:p-0">
            <a href="#" class="block h-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://res.cloudinary.com/jaquanor/image/upload/f_auto,fl_lossy,q_auto/v1583148765/naturelek/stock/black-and-white-board-boardroom-business-260689_nwfboh.jpg"
        ...
        <div class="w-48 h-48 p-2 hover:p-0">
            <a href="#" class="block h-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://res.cloudinary.com/jaquanor/image/upload/f_auto,fl_lossy,q_auto/v1583148766/naturelek/stock/high-rise-building-1662159_vksetx.jpg"
        ...
        <div class="w-48 h-48 p-2 hover:p-0">
            <a href="#" class="block h-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://res.cloudinary.com/jaquanor/image/upload/f_auto,fl_lossy,q_auto/v1583148766/naturelek/stock/clear-wine-glass-on-table-67468_ephfyo.jpg"
        ...
        <div class="w-48 h-48 p-2 hover:p-0">
            <a href="#" class="block h-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://res.cloudinary.com/jaquanor/image/upload/f_auto,fl_lossy,q_auto/v1582793771/naturelek/stock/architecture-black-and-white-business-construction-237836_fxiff6.jpg"
        ...
        <div class="w-48 h-48 p-2 hover:p-0">
            <a href="#" class="block h-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://res.cloudinary.com/jaquanor/image/upload/f_auto,fl_lossy,q_auto/v1583148770/naturelek/stock/photo-of-green-field-near-mountains-974314_njxbbc.jpg"
        ...
        <div class="w-48 h-48 p-2 hover:p-0">
            <a href="#" class="block h-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://res.cloudinary.com/jaquanor/image/upload/f_auto,fl_lossy,q_auto/v1583148766/naturelek/stock/white-bus-on-road-near-cliff-1178448_nn2ah2.jpg"
        ...
        <div class="w-48 h-48 p-2 hover:p-0">
            <a href="#" class="block h-full overflow-hidden rounded-lg shadow-lg">
                <img src="https://res.cloudinary.com/jaquanor/image/upload/f_auto,fl_lossy,q_auto/v1583148768/naturelek/stock/ground-group-growth-hands-461049_e5ra0j.jpg"
